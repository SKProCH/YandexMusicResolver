...
namespace YandexMusicResolver.Loaders {
    public class YandexMusicSearchResultLoader {
        ...
        public YandexMusicSearchResultLoader(string? searchPrefix = null) {
        ...
        public async Task<YandexMusicSearchResult?> LoadSearchResult(YandexSearchType type, string query, YandexMusicPlaylistLoader playlistLoader,
            ...
            try {
                var searchResponse = await WebRequestUtils.ExecuteGet(string.Format(TracksInfoFormat, type, query)).Parse<MetaSearchResponse>();
